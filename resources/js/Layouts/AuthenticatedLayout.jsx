...
export default function AuthenticatedLayout({ header, children }) {
    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex">
            <Sidebar sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} userRole={user.role} theme={theme} toggleTheme={toggleTheme} />
                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="flex h-16 justify-between">
                            ...
                            <div className="hidden sm:ms-6 sm:flex sm:items-center">
                                ...
                                <button
                                    onClick={toggleTheme}
                                    className="p-2 mr-4 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 focus:outline-none"
                                >
                                    {theme === 'dark' ? (
